...
test_funciton <- function(j){
  ...
  setwd("E:/COCA/cov") ### set the working directory to the location of data which needs 
                       ### to be replaced by the user according to the file locations on their own computer. 
                       ### All data is contained in the cov folder. 
